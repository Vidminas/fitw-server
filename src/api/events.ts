...
export const EVENT_BROWSER_MESSAGE = "browser/message";
...
export const EVENT_DO_FITWICK_DELETE = "fitwick/delete";
export const EVENT_DONE_FITWICK_DELETE = "fitwick/delete-done";
